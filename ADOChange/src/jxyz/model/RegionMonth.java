...
public class RegionMonth {
	...
	private String receiver_country_no;
	private String receiver_country_name;
	private String receiver_province_no;
	private String receiver_province_name;
	private String receiver_city_no;
	private String receiver_city_name;
	private String receiver_county_no;
	private String receiver_county_name;
	private String receiver_district_no;
	...
	public RegionMonth(ResultSet rs) throws Exception {
	...
	public String getReceiver_country_no() {
		return receiver_country_no;
	}

	public void setReceiver_country_no(String receiver_country_no) {
		this.receiver_country_no = receiver_country_no;
	}
	...
	public String getReceiver_province_no() {
		return receiver_province_no;
	}

	public void setReceiver_province_no(String receiver_province_no) {
		this.receiver_province_no = receiver_province_no;
	}
	...
	public String getReceiver_city_no() {
		return receiver_city_no;
	}

	public void setReceiver_city_no(String receiver_city_no) {
		this.receiver_city_no = receiver_city_no;
	}
	...
	public String getReceiver_county_no() {
		return receiver_county_no;
	}

	public void setReceiver_county_no(String receiver_county_no) {
		this.receiver_county_no = receiver_county_no;
	}

	public String getReceiver_county_name() {
		return receiver_county_name;
	}

	public void setReceiver_county_name(String receiver_county_name) {
		this.receiver_county_name = receiver_county_name;
	}

	public String getReceiver_district_no() {
		return receiver_district_no;
	}

	public void setReceiver_district_no(String receiver_district_no) {
		this.receiver_district_no = receiver_district_no;
	}
	...
	public String getGroupName() {
		return getPost_org_no() + "-" + getSender_country_no() + "-" + getSender_province_no() + "-"
				...
				+ getReceiver_country_no() + "-" + getReceiver_province_no() + "-" + getReceiver_city_no() + "-"
				+ getReceiver_county_no() + "-" + getReceiver_district_no() + "-" + getPeriod_id();
	}
