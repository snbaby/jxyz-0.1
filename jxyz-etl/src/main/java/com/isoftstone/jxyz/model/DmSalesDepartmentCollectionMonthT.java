...
/**
 * The persistent class for the dm_sales_department_collection_month_t database
 * table.
 * 
 */
@Entity
@Table(name = "dm_sales_department_collection_month_t")
public class DmSalesDepartmentCollectionMonthT extends ActiveRecord<DmSalesDepartmentCollectionMonthT> {
	...
	public DmSalesDepartmentCollectionMonthT() {
	}
